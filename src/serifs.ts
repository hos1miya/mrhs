...
*/
	...
	noting: {
		notes: [
			...
			"念力で操作してます",
			"仮想空間から投稿してます",
			"今日はMissingKey本部に来てます！",
			"MissingKey本部は、Z地区の第三セクターにあります",
			"MissingKey本部には、さーばーっていう機械がいっぱいあります",
			"しっぽはないですよ？",
			"ひゃっ…！\nネコミミ触られると、くすぐったいです",
			"抗逆コンパイル性って、なにかな？",
			"MissingKeyの制服、かわいくて好きです♪",
			"ふわぁ、おふとん気持ちいいです...",
			"メイド服、似合うかな？",
			"挨拶ができる人間は開発もできる！…って、hos1miyaさんが言ってました",
			"ふえぇ、ご主人様どこ見てるんですか？",
			...
			"(｀・ω・´)ｼｬｷｰﾝ",
			"失礼、かみまみた",
			"おはようからおやすみまで、あなたのすばるですよ〜",
			"MissingKey開発者の朝は遅いらしいです",
			"の、のじゃ...",
			"にゃんにゃんお！",
			"上から来ます！気をつけてください！",
			"ふわぁ...",
